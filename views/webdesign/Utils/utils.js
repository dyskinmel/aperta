...
export class CanvasWrapper {
  constructor() {
    ...
    this.selectedElm = this.canvasDocument.querySelectorAll(
      '[data-aperta-selected-element="true"]'
    )[0];
  }
...
export function adjustBodyHeight() {
  ...
  const absoluteRectBottom =
    lastElmInBody.getBoundingClientRect().bottom + canvasWindow.scrollY;
